...
<head>
	...
	<link rel="icon" href="<c:url value='/static/material/images/favicon.ico?' />" type="image/x-icon"><script src="<c:url value='/static/material/js/jquery-1.12.4.js' />" type="text/javascript"></script>
...
<div class="block-header">
	<h2>
		PLANES ALOJAMIENTO <small>Lista de planes</small>
	</h2>
</div>
		...
		<div class="card">
			<div class="header"> 
				 <sec:authorize access="hasRole('ADMIN')">
					<td><a href="<c:url value='new' />" class="btn btn-primary custom-width">Crear plan</a></td>
	 			</sec:authorize>
	 			</div>
