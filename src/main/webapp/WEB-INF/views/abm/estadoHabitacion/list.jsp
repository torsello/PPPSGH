...
<head>
	...
	<title>Estados de Habitaciones</title>
...
<div class="block-header">
	<h2>
		ESTADOS DE HABITACIONES <small>Lista de estados</small>
	</h2>
</div>
		...
		<div class="card">
			<div class="header"> 
				 <sec:authorize access="hasRole('ADMIN')">
					<td><a href="<c:url value='new' />" class="btn btn-primary custom-width">Crear estados</a></td>
	 			</sec:authorize>
	 			</div>
