...
<head>
	...
	<title>Formulario Registro de Tipos Habitacion</title>
						...
						<div class="body">
							<div class="row clearfix">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
									<label for="descripcion">Tipo Habitacion</label>
								</div>
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
										<form:input type="text" path="nombreTipoHabitacion" id="nombreTipoHabitacion" class="form-control"/>
											<div class="has-error">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:input type="number" min="1" path="capacidad" id="capacidad" class="form-control"/>
											<div class="has-error">
