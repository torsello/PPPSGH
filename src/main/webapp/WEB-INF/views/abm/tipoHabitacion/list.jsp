...
<head>
	...
	<title>Tipos de Habitacion</title>
...
<div class="block-header">
	<h2>
		TIPOS DE HABITACION <small>Lista de tipos</small>
	</h2>
</div>
		...
		<div class="card">
			<div class="header"> 
				 <sec:authorize access="hasRole('ADMIN')">
					<td><a href="<c:url value='new' />" class="btn btn-primary custom-width">Crear tipos</a></td>
	 			</sec:authorize>
	 			</div>
