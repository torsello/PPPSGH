...
<head>
	...
	<title>Caracteristicas de Pasajero</title>
...
<div class="block-header">
	<h2>
		CARACTERISTICAS DE PASAJEROS <small>Lista de caracteristicas</small>
	</h2>
</div>
		...
		<div class="card">
			<div class="header"> 
				 <sec:authorize access="hasRole('ADMIN')">
					<td><a href="<c:url value='new' />" class="btn btn-primary custom-width">Crear caracteristica</a></td>
	 			</sec:authorize>
	 			</div>
