							...
							<div class="row clearfix">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:input type="text" path="nombreHotel" id="nombreHotel"
												class="form-control" />
											<div class="has-error">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:input type="number" step="any" path="telefono" id="telefono" class="form-control"/>
											<div class="has-error">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="form-group">
										<div class="form-line">
											<form:input type="text" path="paginaWeb" id="paginaWeb"
											class="form-control" />
											<div class="has-error">
