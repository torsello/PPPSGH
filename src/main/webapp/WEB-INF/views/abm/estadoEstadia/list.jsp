...
<div class="block-header">
	<h2>
		ESTADOS DE ESTADIA <small>Lista de estados estadias</small>
	</h2>
</div>
		...
		<div class="card">
			<div class="header"> 
				 <sec:authorize access="hasRole('ADMIN')">
					<td><a href="<c:url value='new' />" class="btn btn-primary custom-width">Crear estado</a></td>
	 			</sec:authorize>
	 		</div>
...
<% /* ******************************************************************************** *
	  ...
	  ******************************************************************************** */ %>
				        ...
				        <sec:authorize access="hasRole('ADMIN') or hasRole('DBA')">
				        	<th width="100" class="noExport">Accion</th>
				        </sec:authorize>
				        <!--<sec:authorize access="hasRole('ADMIN')">
				        	<th width="100"></th>
				        </sec:authorize>-->
